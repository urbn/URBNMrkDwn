...
let markdownSamples = [
    ...
    MarkDownSample(markdownString: "**See above for the Solid & Stripe size chart to find your best fit.**\n\nRibbed bikini top in a cropped silhouette.\n\n* Pull-on style\n* Non-adjustable straps\n", htmlString: "<p><strong>See above for the Solid &amp; Stripe size chart to find your best fit.</strong></p>\n<p>Ribbed bikini top in a cropped silhouette.</p>\n<ul>\n<li>Pull-on style</li>\n<li>Non-adjustable straps</li>\n</ul>\n")
]
